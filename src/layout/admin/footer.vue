  ...
  <div>
    ...
    <el-row :gutter="20">
     ...
     <el-col :span="20" style="margin: 0px">
       ...
       <div style="margin: 0px;text-align: center;"> <p  style="margin: 0px;">Copyright © 2002-2022 www.aiavr.com All Rights Reserved 版权所有 心世界信息科技有限公司</p></div>
       <div style="margin: 0px;text-align: center;"><p style="margin: 0px;">新世界、背景故事、世界观设定、小说、故事、世界</p></div>
