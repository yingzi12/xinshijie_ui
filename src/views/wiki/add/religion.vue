    ...
    <div>
      <el-form :model="element" label-width="120px">
        <el-form-item label="创造者">
          <el-input v-model="basic.creator" />
        </el-form-item>
        <el-form-item label="基本教义">
          <el-input v-model="basic.doctrine" type="textarea" />
        </el-form-item>
        <el-form-item label="经典">
          <el-input v-model="basic.sutra" type="textarea" />
        </el-form-item>
      </el-form>
    </div>
  </div>
