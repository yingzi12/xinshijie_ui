<template>
        ...
        <div style="padding: 10px">
          <el-space wrap>
              ...
              <el-button text :type="props.headType==2? 'primary':''">  <router-link :to="{path:'/admin/storyAuthor', query: {sid:props.sid,sname:props.sname,wid:story.wid,wname:story.wname}}">作者</router-link></el-button>
              <el-badge  :hidden="story.countAuditAuthor > 0 ? false:true"  :value="story.countAuditAuthor" class="item" >
                  <el-button text v-if="story.authorType == 3"  :type="props.headType==10? 'primary':''">  <router-link :to="{path:'/admin/storyApplyAuthor', query: {headType:10,sid:props.sid,sname:props.sname,wid:story.wid,wname:story.wname}}">作家审核</router-link></el-button>
              </el-badge>
              ...
              <el-badge :hidden="story.countAuditChapter>0 ? false:true" :value="story.countAuditChapter" class="item" >
              ...
              <el-button text :type="props.headType==5? 'primary':''">  <router-link :to="{path:'/admin/storyComment', query: {sid:props.sid,sname:props.sname,wid:story.wid,wname:story.wname}}">评论</router-link></el-button>
              <el-badge :hidden="story.countAuditDiscuss>0 ? false:true" :value="story.countAuditDiscuss" class="item" >
              <el-button text :type="props.headType==6? 'primary':''">  <router-link :to="{path:'/admin/storyDiscuss', query: {sid:props.sid,sname:props.sname,wid:story.wid,wname:story.wname}}">讨论</router-link></el-button>
              </el-badge>
          </el-space>
        </div>
</template>
