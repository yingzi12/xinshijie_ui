  ...
  <!--        多选-->
    <div style="padding: 10px">
        <el-space wrap>
            ...
            <el-badge :value="world.countAuditELement" class="item" v-if="world.countAuditELement>0">
            ...
            <el-badge :value="world.countAuditDiscuss" class="item" v-if="world.countAuditDiscuss>0">
