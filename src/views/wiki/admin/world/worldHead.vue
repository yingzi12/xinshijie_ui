  ...
  <!--        多选-->
    <div style="padding: 10px">
        <el-space wrap>
            ...
            <el-badge v-if="world.countAuditStory>0" :value="world.countAuditStory" class="item" >
                <el-button text  :type="props.headType==11? 'primary':''">  <router-link :to="{path:'/admin/worldStoryAudit', query: {headType:11,wid:props.wid,wname:props.wname}}">元素审核</router-link></el-button>
            </el-badge>
